...
builder.Services.AddScoped<BOOK.SERVERS.ISysUserService,BOOK.SERVERS.SysUserServiceImp>();
builder.Services.AddScoped<DB_SysUser>();
builder.Services.AddScoped<Redis_SysUser>();
