<template>
  <div>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-link class="linetext" type="primary" @click="ClickAudit(scope.row)">审查通过</el-link>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
import { GetAllAudit, Audit } from '@/api/borrowed.js'
export default {
  data() {
    return {
